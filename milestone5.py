...
with open("Milestone_Input\Milestone_Input\Milestone 5\Source.txt","r") as f:
    lines = f.readlines()
...
target_points = []
n = 0
with open("Milestone_Input\Milestone_Input\Milestone 5\POI.txt","r") as d:
    for i in d:
        if "xy" in i:
            temp = []
            l = i.split()
...
for i in lines:
    if "xy" in i:
        ...
        if dist_match(temp,target_points[0]): #or dist_match(temp,target_points[1]):
            o.write("boundary\n")
            o.write("layer 1\n")
            o.write("datatype 0\n")
            o.write(i)
