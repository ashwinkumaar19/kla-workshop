...
with open("Milestone_Input\Milestone_Input\Milestone 4\Source.txt","r") as f:
    lines = f.readlines()
...
target_points = []
n = 0
with open("Milestone_Input\Milestone_Input\Milestone 4\POI.txt","r") as d:
    for i in d:
        if "xy" in i:
            temp = []
            l = i.split()
